...
namespace Interpreter.Reserved {
    partial class Functions {
        public static object ArrayCast_Fu(Interpreter m) {
        ...
        //casting
        public static object ListCast_Fu(Interpreter m) {
        ...
        public static object IntCast_Fu(Interpreter m) {
            object toCast = s.GetValue(new Id("~toCast"));
            return Convert.ChangeType(toCast, typeof(int));
        }
        public static object DoubleCast_Fu(Interpreter m) {
            object toCast = s.GetValue(new Id("~toCast"));
